    ...
    def init = { servletContext ->
		...
		//	[CODE, NAME, NOTES, HELP, CATEGORY, CQM, PRODUCTS:[] ],
			...
			["AdvDir", 
				...
				"MENU", "", ["MU1","MU2"]],
			["LabTests (Menu)", "Laboratory Test Results", 
				"", 
				"", 
				"MENU", "", ["MU1"]],
			["EDURes (Menu)", "Education Resources", 
				"", 
				"", 
				"MENU", "", ["MU1"]],
			["MedRec (Menu)", "Medication Reconciliation", 
				"", 
				"", 
				"MENU", "", ["MU1"]],
		...
		def _elements = [
			...
			["FamHX", "Family History (structured data recording first degree relative health history)", "", "HospitalSpecific", ["FamHx"],["MEDITECH 6.0", "MEDITECH 6.1"]],
			["ImgRecNum", "Explanation(results) that corresponds to an image (please answer both questions and add additional information if needed) : Are there image record numbers or identifiers that correspond to the text result?", "", "HospitalSpecific", ["FamHx"],["MEDITECH 6.0", "MEDITECH 6.1"]],
			["ImgRecFlg", "Explanation(results) that corresponds to an image (please answer both questions and add additional information if needed) : Is there a flag that signifies an image has been read and a report generated and placed in the record?", "", "HospitalSpecific", ["FamHx"],["MEDITECH 6.0", "MEDITECH 6.1"]],
